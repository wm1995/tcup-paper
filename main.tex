...
introduce the parameter $O_i$ to indicate whether the $i$th datapoint is
...
For this test, we compare model performance on a symmetric, heavy-tailed
distribution that does not fall into the family of $t$-distributions. Therefore,
we use a Laplace distribution as the noise distribution, giving an example of
performance under explicit model misspecification.
