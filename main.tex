...
\citealt{Blanton:2003, Kelly:2008} -- see also \citealt{Johnston:2013} for a
...
astronomy:
\begin{itemize}
    \item the Schechter function \citep{Schechter:1976}
    \begin{equation}
        \Phi(L; \alpha, L_*, \phi_*)
          = \phi_* \left(\frac{L}{L_*}\right)^\alpha
            \exp \left(\frac{L}{L_*}\right)
    \end{equation}
    \item the double power law function (first discussed in \citealt{Boyle:1987}
    and then presented explicitly in \citealt{Boyle:1988})
    \begin{equation}
...
\begin{figure*}
    ...
    \caption{A mixture model approximation to common astronomical population
    models}
