...
\ref{fig:results.laplace.corner}, $t$-cup successfully recovers the values of
the parameters that were used to generate the dataset.
...
\begin{table}
    ...
    $\sigma = 1.4826 \, \text{MAD}$, where MAD is the median absolute deviation.}
