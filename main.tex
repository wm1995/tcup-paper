...
Andreon:2020}. While code examples which incorporate Student's $t$-distributions
are available (e.g.\ Appendix C.2 of \citealt{Gelman:2013}, Section 9.1.3 of
\citealt{Andreon:2015}, or Example 7.35 of \citealt{McElreath:2020}), there is
not currently a generic robust method for robust Bayesian regression in
astronomy.
...
gradients that would be present in an unparameterized model \citep{Neal:2003,
