...
if __name__ == "__main__":
    ...
    for dataset, model, prior in it.product(datasets, models, plot_prior):
        ...
        if dataset == "gaussian_mix":
            ...
            ax[0, 1].set_xlabel(r"$\hat{\beta}_0$")
            ax[1, 1].set_xlabel(r"$\hat{\beta}_1$")
        else:
            if model == "tcup":
                plot_cdf(
                    df["nu"],
    ...
    if dataset == "t":
        ...
        # Set axis limits
        ax[0, 0].set_xlim(2.5, 3.5)
        ax[0, 1].set_xlim(1.8, 2.2)
        ...
        ax[1, 0].axvline(0.2 * 1.14787, c="k")

        # Set axis limits
        ax[0, 0].set_xlim(-2, 0)
        ax[0, 1].set_xlim(0.5, 1.1)
        ax[1, 0].set_xlim(0, 0.6)
        ax[1, 1].set_xlim(0, 20)
    elif dataset == "lognormal":
        # Set ground truth lines
        ax[0, 0].axvline(4, c="k")
        ax[0, 1].axvline(8, c="k")
        ax[1, 0].axvline(0.2, c="k")
        ...
        # Set ground truth lines
        ax[0, 0].axvline(2, c="k")
        ax[0, 1].axvline(3, c="k")
        # Scaling for sigma_68
        # sigma_int = 0.4
        # sigma_68 = 0.45859
        ax[1, 0].axvline(0.45859, c="k")
        ax[1, 1].axvline(-1, c="k")
